 ...
 */
declare function useValidation<T extends Record<string, any>>(initialValues: T, schema: Schema<T>, options?: UseValidationOptions): UseValidationReturn<T>;

export { type FieldErrors, type FieldValue, type Rule, type Schema, type UseValidationOptions, type UseValidationReturn, type ValidateSchemaResult, type ValidationResult, ageMinYears, alpha, alphaSpaces, alphanumeric, between, creditCard, custom, email, exactLength, fail, fileRequired, fileType, formatBytes, imageMaxDimensions, integer, isDate, isEmpty, matchField, max, maxDate, maxFileCount, maxFileSize, maxLength, maxSelected, min, minDate, minFileCount, minFileSize, minLength, minSelected, mustBeChecked, negative, noWhitespace, notPlaceholder, numeric, numericString, ok, oneOf, oneOfStrings, pattern, phone, positive, required, selectedBetween, step, timeBetween, toFileArray, url, useValidation, validateField, validateFieldAsync, validateSchema, validateSchemaAsync, zipCode };
